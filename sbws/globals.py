...
# To have sbws to vote on approximately the same number of relays as Torflow,
# leave it as None, to don't exclude measurements.
DAY_SECS = None
# Minimum number of measurements for a relay be included as a relay to vote on.
# Ideally, this should be 2.
# As the constant before, leave it as 1 to don't exclude measurements.
NUM_MIN_RESULTS = 1
MIN_REPORT = 60
