...
# NOTE: in a future refactor, replace all the code that check whether a
# measurement or relay is older than the measurement period.
def is_old(timestamp, measurements_period=settings.MEASUREMENTS_PERIOD):
